      ...
      <div className="relative flex-2 w-[1000px] lg:w-9/12 flex justify-center items-center bg-black">
        ...
        <div className="relative">
          <div className="lg:h-[100vh] h-[60vh]">
            <video ref={videoRef} src={post.video.asset.url} loop onClick={onVideoClick} className="h-full cursor-pointer"></video>
          </div>

          <div className="absolute top-[47%] left-[45%] cursor-pointer">
            {!isPlaying && (
        ...
        <div className="absolute bottop-5 lg:bottom-10 right-5 lg:right-10 cursor-pointer">
          {isVideoMuted ? (
              ...
              <Link href="/">
                <div className="mt-3 flex flex-col gap-2">
                  <p className="flex gap-2 items-center md:text-md font-bold text-primary">
                    {post.postedBy.userName} <GoVerified className="text-green-500" />
                  </p>
